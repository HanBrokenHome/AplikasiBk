...
const SettingsPage = () => {
    return (
        <div className="flex min-h-screen bg-gray-100 p-4">
            ...
            <div>
                <h1>Update data siswa lewat excel</h1>
            </div>
            <div className='w-full bg-slate-200 rounded shadow-xl p-5 h-80'>
                <p>Kamu harus memenuhi syarat konfigurasi excel supaya tidak erro saat Upload dan Filter file</p>
